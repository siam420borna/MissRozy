...
BANNED_CHANNELS = list(set(int(x) for x in str(getenv("BANNED_CHANNELS", "-1002674031223")).split())) 
STREAM_LOGS = environ.get('STREAM_LOGS','-1002589776901')
...
class Config(object):
	...
	DB_CHANNEL = int(os.environ.get("DB_CHANNEL", -1002674031223))
	...
	UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL", "-1002674031223")
